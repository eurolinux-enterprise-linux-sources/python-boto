...
# Submitted upstream at https://github.com/boto/boto/pull/2890
Patch0:         0001-Switch-to-M2Crypto-library.patch
...
Provides:       python2-boto = %{epoch}:%{version}-%{release}
Obsoletes:		python2-boto < %{epoch}:%{version}-%{release}
...
%changelog
* Mon Feb 20 2017 Charalampos Stratakis <cstratak@redhat.com> - 1:2.34.0-6
- Bump release for rebuild

* Mon Feb 20 2017 Charalampos Stratakis <cstratak@redhat.com> - 1:2.34.0-5
- Import to RHEL 6.9
- Use the epoch tag so the EPEL 6 package can be replaced
Resolves: rhbz#1423029

* Fri Jan 16 2015 Ken Dreyer <kdreyer@redhat.com> - 2.34.0-5
- Patch to use m2crypto instead of rsa (RHBZ #1184596)
